        ...
        return new ImageResponse(
            (
                ...
                >
                    ...
                    <div style={{ fontSize: 50, fontWeight: 'bold', color: '#1f2937', marginBottom: 40 }}>
                        {state.timerName || typeLabel}
                    </div>
                    <div
                        style={{
                            display: 'flex',
                    ...
                    <div style={{ fontSize: 36, color: '#6b7280', marginTop: 40 }}>
                        {typeLabel} • {statusLabel}
                    </div>
                    <div style={{ position: 'absolute', bottom: 40, fontSize: 24, color: '#9ca3af' }}>
